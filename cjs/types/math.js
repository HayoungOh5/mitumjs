...
class Big {
        ...
        switch (typeof big) {
            ...
            case "object":
                if (big instanceof Buffer || big instanceof Uint8Array) {
                    ...
                    throw index_js_1.MitumError.detail(index_js_1.ECODE.INVALID_BIG_INTEGER, "wrong big");
                }
                break;
            default:
                throw index_js_1.MitumError.detail(index_js_1.ECODE.INVALID_BIG_INTEGER, "wrong big");
    ...
    toBuffer(option) {
        ...
        if (option === "fill") {
            index_js_1.Assert.check(size <= 8, index_js_1.MitumError.detail(index_js_1.ECODE.INVALID_BIG_INTEGER, "big out of range"));
...
class Uint8 {
    constructor(n) {
        index_js_1.Assert.check(0 <= n && n <= 255, index_js_1.MitumError.detail(index_js_1.ECODE.INVALID_UINT8, "uint8 out of range"));
        this.n = n;
    }
    static from(n) {
