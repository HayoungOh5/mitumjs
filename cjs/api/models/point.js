...
const url = (api, contract) => `${index_js_2.IP.from(api).toString()}/point/${index_js_1.Address.from(contract).toString()}`;
...
function getPointBalance(api, contract, account, delegateIP) {
    return __awaiter(this, void 0, void 0, function* () {
        const apiPath = `${url(api, contract)}/account/${index_js_1.Address.from(account).toString()}`;
        return !delegateIP ? yield axios_1.default.get(apiPath) : yield axios_1.default.get(delegateUri(delegateIP) + encodeURIComponent(apiPath));
    });
}
exports.default = {
