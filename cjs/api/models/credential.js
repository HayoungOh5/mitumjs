...
const url = (api, contract) => `${index_js_2.IP.from(api).toString()}/did/${index_js_1.Address.from(contract).toString()}`;
...
function getCredentialByHolder(api, contract, holder, delegateIP) {
    return __awaiter(this, void 0, void 0, function* () {
        const apiPath = `${url(api, contract)}/holder/${index_js_1.Address.from(holder).toString()}`;
        return !delegateIP ? yield axios_1.default.get(apiPath) : yield axios_1.default.get(delegateUri(delegateIP) + encodeURIComponent(apiPath));
    });
}
exports.default = {
