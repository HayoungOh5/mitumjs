...
class AddCustomerItem extends item_js_1.KYCItem {
    constructor(contract, customer, status, currency) {
        super(index_js_2.HINT.KYC.ADD_CUSTOMER.ITEM, contract, currency);
...
class AddCustomerFact extends index_js_1.OperationFact {
    constructor(token, sender, items) {
        super(index_js_2.HINT.KYC.ADD_CUSTOMER.FACT, token, sender, items);
    ...
    get operationHint() {
        return index_js_2.HINT.KYC.ADD_CUSTOMER.OPERATION;
    }
}
