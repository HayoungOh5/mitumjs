...
class AddControllerItem extends item_js_1.KYCItem {
    constructor(contract, controller, currency) {
        super(index_js_2.HINT.KYC.ADD_CONTROLLER.ITEM, contract, currency);
...
class AddControllerFact extends index_js_1.OperationFact {
    constructor(token, sender, items) {
        super(index_js_2.HINT.KYC.ADD_CONTROLLER.FACT, token, sender, items);
    ...
    get operationHint() {
        return index_js_2.HINT.KYC.ADD_CONTROLLER.OPERATION;
    }
}
