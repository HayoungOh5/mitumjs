...
class ApproveFact extends fact_js_1.TokenFact {
    constructor(token, sender, contract, currency, approved, amount) {
        super(index_js_2.HINT.TOKEN.APPROVE.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return index_js_2.HINT.TOKEN.APPROVE.OPERATION;
    }
}
