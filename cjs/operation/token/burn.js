...
class BurnFact extends fact_js_1.TokenFact {
    constructor(token, sender, contract, currency, target, amount) {
        super(index_js_2.HINT.TOKEN.BURN.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return index_js_2.HINT.TOKEN.BURN.OPERATION;
    }
}
