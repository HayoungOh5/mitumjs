...
class MintFact extends fact_js_1.TokenFact {
    constructor(token, sender, contract, currency, receiver, amount) {
        super(index_js_2.HINT.TOKEN.MINT.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return index_js_2.HINT.TOKEN.MINT.OPERATION;
    }
}
