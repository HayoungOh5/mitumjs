...
class CreateContractAccountItem extends item_js_1.CurrencyItem {
    constructor(keys, amounts, addressType) {
        super(index_js_3.HINT.CURRENCY.CREATE_CONTRACT_ACCOUNT.ITEM, amounts, addressType);
        this.keys = keys;
...
class CreateContractAccountFact extends index_js_1.OperationFact {
    constructor(token, sender, items) {
        super(index_js_3.HINT.CURRENCY.CREATE_CONTRACT_ACCOUNT.FACT, token, sender, items);
    ...
    get operationHint() {
        return index_js_3.HINT.CURRENCY.CREATE_CONTRACT_ACCOUNT.OPERATION;
    }
}
