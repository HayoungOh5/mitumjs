...
class RevokeOperatorItem extends item_js_1.STOItem {
    constructor(contract, operator, partition, currency) {
        super(index_js_2.HINT.STO.REVOKE_OPERATOR.ITEM, contract, currency);
...
class RevokeOperatorFact extends index_js_1.OperationFact {
    constructor(token, sender, items) {
        super(index_js_2.HINT.STO.REVOKE_OPERATOR.FACT, token, sender, items);
    ...
    get operationHint() {
        return index_js_2.HINT.STO.REVOKE_OPERATOR.OPERATION;
    }
}
