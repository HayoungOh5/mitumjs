...
class TransferFact extends fact_js_1.PointFact {
    constructor(token, sender, contract, currency, receiver, amount) {
        super(index_js_2.HINT.POINT.TRANSFER.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return index_js_2.HINT.POINT.TRANSFER.OPERATION;
    }
}
