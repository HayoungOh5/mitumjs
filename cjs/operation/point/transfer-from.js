...
class TransferFromFact extends fact_js_1.PointFact {
    constructor(token, sender, contract, currency, receiver, target, amount) {
        super(index_js_2.HINT.POINT.TRANSFER_FROM.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return index_js_2.HINT.POINT.TRANSFER_FROM.OPERATION;
    }
}
