...
const register_point_js_1 = require("./register-point.js");
...
class Point extends index_js_1.ContractGenerator {
    constructor(networkID, api, delegateIP) {
        super(networkID, api, delegateIP);
    }
    registerPoint(contractAddr, sender, currency, name, symbol, initialSupply) {
        return new index_js_1.Operation(this.networkID, new register_point_js_1.RegisterPointFact(index_js_3.TimeStamp.new().UTC(), sender, contractAddr, currency, symbol, name, initialSupply !== null && initialSupply !== void 0 ? initialSupply : 0));
    }
    ...
    getPointInfo(contractAddr) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield (0, index_js_2.getAPIData)(() => index_js_2.contract.point.getPoint(this.api, contractAddr, this.delegateIP));
    ...
    getPointBalance(contractAddr, owner) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield (0, index_js_2.getAPIData)(() => index_js_2.contract.point.getPointBalance(this.api, contractAddr, owner, this.delegateIP));
            return data ? data._embedded : null;
        });
    }
}
