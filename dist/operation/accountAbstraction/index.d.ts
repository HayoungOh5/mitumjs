import { Fact, UserOperation, OperationJson, HintedFactObject } from "../base";
...
export declare class AccountAbstraction extends Generator {
     ...
     */
    createUserOperation(fact: Fact | HintedFactObject, contract: string | Address, authentication_id: string): UserOperation<Fact>;
    /**
