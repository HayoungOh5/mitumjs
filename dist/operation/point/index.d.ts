...
export declare class Point extends ContractGenerator {
     ...
     */
    getPointInfo(contractAddr: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getPointBalance(contractAddr: string | Address, owner: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
}
