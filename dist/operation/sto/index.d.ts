...
export declare class STO extends ContractGenerator {
     ...
     */
    getPartitionsInfo(contractAddr: string | Address, holder: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getBalanceByHolder(contractAddr: string | Address, holder: string | Address, partition: string): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getOperatorsByHolder(contractAddr: string | Address, holder: string | Address, partition: string): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getPartitionBalanceInfo(contractAddr: string | Address, partition: string): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getAuthorizedInfo(contractAddr: string | Address, operator: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
}
export {};
