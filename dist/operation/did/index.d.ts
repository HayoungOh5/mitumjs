...
import { ContractGenerator, BaseOperation, AllowedOperation } from "../base";
...
export declare class Did extends ContractGenerator {
     ...
     */
    registerModel(contract: string | Address, sender: string | Address, didMethod: string, currency: string | CurrencyID): BaseOperation<RegisterModelFact>;
    /**
     ...
     */
    create(contract: string | Address, sender: string | Address, currency: string | CurrencyID): BaseOperation<CreateFact>;
    /**
     ...
     */
    updateDocument(contract: string | Address, sender: string | Address, document: Document, currency: string | CurrencyID): BaseOperation<UpdateDocumentFact>;
    /**
     ...
     */
    updateDocumentByDocumentJson(contract: string | Address, sender: string | Address, documentJson: document, currency: string | CurrencyID): BaseOperation<UpdateDocumentFact>;
    /**
