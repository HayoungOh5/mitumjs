...
export declare class Token extends ContractGenerator {
     ...
     */
    getTokenInfo(contractAddr: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getAllowance(contractAddr: string | Address, owner: string | Address, approved: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
    /**
     ...
     */
    getTokenBalance(contractAddr: string | Address, owner: string | Address): Promise<import("../../types").SuccessResponse | import("../../types").ErrorResponse>;
}
