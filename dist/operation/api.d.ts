...
export declare class Operation extends Generator {
     ...
     */
    sign(privatekey: string | Key | KeyPair, operation: BaseOperation<Fact>, option?: SignOption): Promise<BaseOperation<Fact>>;
    /**
     ...
     * sendOperation();
     */
    send(operation: HintedObject | BaseOperation<Fact>, headers?: {
        [i: string]: any;
     ...
     */
    estimateFee(operation: HintedObject | BaseOperation<Fact>, currencyID: string | CurrencyID): Promise<FeeEstimate>;
}
